...
# ```
# run_experiment -b array_track_video_set_1.sh -e text_lists/set_1.txt -m 12
# ```
...
project_name=sleap
subfolder_name=set_1

#Move the model folders across too
DFS_HOME=/home/${USER}

models="${project_name}/data/models"
input="${project_name}/data/input/${subfolder_name}"
output="${project_name}/data/output/${subfolder_name}"
